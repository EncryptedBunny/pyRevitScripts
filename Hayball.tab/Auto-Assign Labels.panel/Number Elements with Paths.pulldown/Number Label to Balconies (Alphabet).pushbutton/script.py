...
__doc__ = "Assigns Balcony numbers with \'Item No\' BAL, using the 'Label Maker' line style as the path of order. Deletes 'Label Maker' lines at completion."
...
class IForm(Form):
    ...
    def __init__(self):
        ...
        head = Label(Text = 'Options for automatically numbering Balcony Numbers using the "Label Maker" Line style. Lines will be deleted after completion')
        self.Controls.Add(head)
        head.Size = Size(200,50)
        head.Location = Point(10,8)

        lb = Label(Text = 'Letter to start from:')
...
with DB.Transaction(doc, "Numbering Balconies") as trans:
